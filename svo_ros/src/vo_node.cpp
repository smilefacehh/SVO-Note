...
/**
 * 注：vk命名空间来自rgp_vikit包
 * install wiki：https://github.com/uzh-rpg/rpg_svo/wiki/Installation:-ROS
 * run wiki:https://github.com/uzh-rpg/rpg_svo/wiki/Run-SVO-with-ROS
*/
